...
function login($conn, $input){
    ...
    $result = mysqli_query($conn, "SELECT user_id, username, password, app_role_id, agentra_role, company_id FROM " . CORE_SCHEMA . ".app_user WHERE username = '$email' AND app_id = '7c2e6a2f-b254-4bbb-87f2-c6ece0f88db2' LIMIT 1");
